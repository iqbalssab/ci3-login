                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800"><?= $title; ?></h1>
                        ...
                        <div class="row">
                            <div class="col-lg">
                                <!-- Kalo gak ngisi form keluar ini -->
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a href="<?= base_url('menu/subdelete/').$sm['id']; ?>" class="badge badge-danger" onclick="return confirm('delete menu?');">Delete</a>
                                        </td>
                                    </tr>
...
<div class="modal fade" id="editSubMenuModal<?= $sm['id'];?>" tabindex="-1" aria-labelledby="editSubMenuModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('menu/subedit/').$sm['id']; ?>" method="post">
      <div class="modal-body">
